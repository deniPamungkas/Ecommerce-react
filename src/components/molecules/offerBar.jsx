...
const OfferBar = () => {
  return (
    <div className="w-full md:h-[150px] lg:h-[230px] xl:h-[270px] bg-filter px-5 md:px-10 lg:px-16 flex gap-y-3 md:gap-y-0 py-5 flex-wrap items-start md:flex-nowrap md:items-center justify-between">
      {offer.map((item) => {
        return (
          <li
            key={item.name}
